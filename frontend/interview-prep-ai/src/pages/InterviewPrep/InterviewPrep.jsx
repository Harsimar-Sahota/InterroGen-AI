...
const uploadMoreQuestions = async () => {
  try {
    ...
    // 1. Generate additional questions from AI
    const aiResponse = await axiosInstance.post(
      API_PATHS.AI.GENERATE_QUESTIONS,
      {
        ...
        numberOfQuestions: 5, // adjust as needed
      }
    );
    ...
    if (!generatedQuestions.length) {
      setErrorMsg("No questions generated. Please try again.");
      return;
    }

    // 2. Save the new questions to the session
    const response = await axiosInstance.post(
    ...
    if (response.data) {
      ...
      fetchSessionDetailsById(); // Refresh session data
    }
  } catch (error) {
